...
<section class="header">
   ...
   <nav class="navbar">
      ...
      <a href="transport_service.php">Transport</a>
      <a href="tp_comapnies.php">Tp Companies</a>
   </nav>
...
<section class="home">
   ...
   <div class="swiper home-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide" style="background:url(images/dege.jpg) no-repeat">
            <div class="content">
               <span>explore, discover, travel</span>
               <h3>TRAVEL THE WOLRD</h3>
...
<section class="services">
   ...
   <h1 class="heading-title"> TRANSPORT SERVICES OFFERED </h1>

   <div class="box-container">

      <div class="box">
         <img src="images/bus.jpg" alt="">
         <h3><a href="transport_service.php">Buses</a></h3>
      </div>

      <div class="box">
         <img src="images/train.webp" alt="">
        <h3>Trains</h3>
      </div>
...
<section class="home-about">
   ...
   <div class="content">
      <h3>about us</h3>
      <p>Located in the central Business  of Nairobi. <br> 
         This is the number one travel agency that caters towards ensuring every adventure is worthwile! <br>
         Feel free to visit our offices on XXXX along YYYY Rd.</p>
