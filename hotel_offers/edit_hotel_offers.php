...
<body>
	...
	<div class = "form_container" style="background:url(../images/offer.jpg) repeat">
		<form action = "" method = "post">
			<?php
				$edit_id = $_POST['submit'];
				
				$sql = "SELECT * FROM offer_ WHERE id = '$edit_id'";
			...
			<div class = "hotel_id_dropdown">
				...
				<select class = "hotel_id_dropdown" id = "hotel_id_dropdown" name = "hotel_id_dropdown"> 
					<?php
						$result = mysqli_query($con,"SELECT * FROM offer_hotel") or trigger_error("Query Failed! SQL: $sql - Error: ".mysqli_error($con), E_USER_ERROR);
			...
			<button type = "submit" name = "submit" id = "submit"> Confirm Edits </button>
		</form>
	</div>
</body>
